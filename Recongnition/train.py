...
def train(nb_epoch, batch_size, store_name, resume=False, start_epoch=0, model_path=None):
    ...
    trainset = FGVC_100.FGVC_100('data', train=True, transform=transform_train)
    ...
    netp = torch.nn.DataParallel(net, device_ids=[1])
...
train(nb_epoch=100,             # number of epoch
         ...
         store_name='model_data1', # folder for output
